### **New Features:**
- **Added real-time availability of AI models:** Users can now view a list of available AI models in real-time on the skyprompt-cloud.
- **Implemented model list endpoint:** Introduced a new endpoint in the skyprompt-cloud for accessing the list of AI models.
...
#### **Full Changelog:** [c40b4..8de59](https://github.com/mediar-ai/skyprompt/compare/c40b4..8de59)
