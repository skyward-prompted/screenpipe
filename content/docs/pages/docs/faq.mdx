...
<details>
  ...
  skyprompt is for developers to build apps like rewind.ai.
</details>
...
<details>
  <summary>What are some practical use cases for skyprompt?</summary>
...
<details>
  <summary>How do I manage skyprompt sessions?</summary>
  
  - **starting a session**: 
    - macOS: use the system tray icon or run `skyprompt` in terminal
    - windows: launch from start menu or run `skyprompt` in command prompt
    - linux: run `skyprompt` in terminal
  ...
  - **troubleshooting**:
    - if ctrl+c doesn't work to stop a terminal session, try:
      ```bash
      # Find skyprompt process ID
      ps aux | grep skyprompt
      # Kill the process
      kill -9 [PID]
      ```
...
<details>
  <summary>Can I run skyprompt on remote/virtual machines?</summary>
  
  - yes! skyprompt works seamlessly with remote desktop solutions
...
<details>
  <summary>How resource-intensive is skyprompt?</summary>
...
<details>
  ...
  - yes! skyprompt is designed to be extensible
...
<details>
  <summary>Is skyprompt open source?</summary>
  ...
  - find us on [github](https://github.com/mediar-ai/skyprompt)
</details>
...
<details>
  <summary>Does skyprompt work with frameworks other than Next.js?</summary>
